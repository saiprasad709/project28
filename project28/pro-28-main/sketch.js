...
function setup() {
	...
	mango2 = new Mango(700,230,30);
	mango3= new Mango(750,320,30);
	mango4 = new Mango(850,330,30);
	mango5 = new Mango(650,320,30);
	mango6 = new Mango(900,200,30);
  mango7 = new Mango(800,250,30);
  mango8=new Mango(950,340,30);
  mango9=new Mango(930,260,30)
  tree = new Tree(780,680);
